...
PY_VERSION = '.'.join("%s" % i for i in sys.version_info[:2])
...
if not os.path.isfile("try_perlapi.c") or \
       os.path.getmtime("try_perlapi.c") < os.path.getmtime("try_perlapi.pl") or \
       not os.path.isfile("try_perlapi.h"):
